...
from utiles.email_send import send_register_email
# 检测用户是否登录
...
class ModifyPwdView(View):
    ...
    def post(self, request):
        ...
        if modify_from.is_valid():
            ...
            email = request.POST.get('email', '')
            return render(request, 'password_reset.html', {'email': email, 'msg': modify_from})
...
class MymessageView(LoginRequiredMixin, View):
    ...
    def get(self,request):
        ...
        try:
            ...
            page = 1
        p = Paginator(all_message, per_page=3, request=request)
